...
if (!empty($_GET['id'])) {
  ...
  if ($connect->affected_rows) {
    ...
    header("location: ../5_bazy_tabela_update.php?error=0&info=Usunięto użytkownika o id: $_GET[id]");
  }
  else {
    ...
    header("location: ../5_bazy_tabela_update.php?error=1&info=Nie udało się usunąć rekordu");
  }
}
else {
  //header("location: ../3_bazy_tabela_delete.php");
  header("location: ../5_bazy_tabela_update.php");
}
?>
